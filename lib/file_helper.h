...
/**
 * @brief Separate name-like structure from the beginning of the string.
 * 
 * @param ptr pointer to the start of the line
 * @return LimitedString 
 */
LimitedString identify_name(const char* ptr);

/**
 * @brief Check if string begins with specified sequence of characters.
 * 
 * @param string 
 * @param prefix 
 * @return true 
